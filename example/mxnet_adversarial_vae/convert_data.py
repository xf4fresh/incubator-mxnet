...
def parse_args():
    ...
    parser.add_argument('--dataset', help='caltech101 dataset mat file path',
                        default='/home/ubuntu/datasets/caltech101/data/caltech101_silhouettes_28.mat', type=str)
    parser.add_argument('--save_path', help='path to save the images', default='/home/ubuntu/datasets/caltech101/data/',
                        type=str)
    parser.add_argument('--invert',
                        help='invert the image color i.e. default shapes are black and background is white in caltech101, invert the shapes to white',
                        action='store_true')
