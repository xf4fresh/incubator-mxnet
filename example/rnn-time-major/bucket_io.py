...
class SimpleBatch(object):
    ...
    def provide_label(self):
        return [mx.io.DataDesc(n, x.shape, layout=l) for n, x, l in
                zip(self.label_names, self.label, self.label_layouts)]
...
class BucketSentenceIter(mx.io.DataIter):
    def __init__(self, path, vocab, buckets, batch_size,
        ...
        if self.time_major:
            self.provide_data = [mx.io.DataDesc('data', (self.default_bucket_key, batch_size),
                                                layout='TN')] + init_states
