...
class htkReader(BaseReader):
    ...
    def Read(self):
        ...
        with open(self.featureFile, "rb") as f:
            ...
            dt = numpy.dtype(
                [('numSamples', (numpy.int32, 1)), ('sampPeriod', (numpy.int32, 1)), ('sampSize', (numpy.int16, 1)),
                 ('sampKind', (numpy.int16, 1))])
            ...
            samples = numpy.fromfile(f, dt.newbyteorder('>' if self.byteOrder == ByteOrder.BigEndian else '<'),
                                     count=numSamples)
