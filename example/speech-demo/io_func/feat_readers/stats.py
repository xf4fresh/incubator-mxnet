...
class FeatureStats(object):
    ...
    def Load(self, filename):
        with open(filename, "rb") as f:
            dt = numpy.dtype(
                [('magicNumber', (numpy.int32, 1)), ('numSamples', (numpy.int32, 1)), ('dim', (numpy.int32, 1))])
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Print the mean and standard deviation from a stat file',
